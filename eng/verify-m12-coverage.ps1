...
$sourceChecks = @{
    ...
    'src\JYPPX.ROCm.MIGraphX.CSharp.API\MIGraphXGraph.cs' = @('MIGraphXModule', 'MIGraphXInstruction', 'MIGraphXOperation', 'Create(string nativeLibraryPath, string name)', 'DecodeRequiredBuffer', 'byte.MaxValue', 'Clone()')
    ...
    'src\JYPPX.ROCm.MIGraphX.CSharp.API\MIGraphXExperimentalCustomOp.cs' = @('SetCompute', 'InvokeCompute', 'WriteCallbackException', '(bytes[copy] & 0xC0) == 0x80', 'Register', 'CopyState', 'clone.IsAllocated', 'GC.KeepAlive(callback)')
