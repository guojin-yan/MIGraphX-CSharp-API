...
$sourceChecks = @{
    ...
    'tools\radeon\cloud-test.sh' = @('m12-runtime-probe/run.sh', '--include-deferred', 'm12-candidate', 'm12-review.txt', 'm12CaseFilter', 'm12ExecutedCases', 'candidate-record-verified')
}
