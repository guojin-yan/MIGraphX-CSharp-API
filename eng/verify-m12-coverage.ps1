...
$sourceChecks = @{
    ...
    'tools\m12-runtime-probe\Program.cs' = @('runtime-candidate-executed-review-required', 'm12-shape-argument-factories', 'RunTensorFlowParse', 'RunQuantizationOptions', 'RunCustomOpRegistration', 'RunConcurrentDispose', 'cases.Take(7)', 'DeferredCases', 'case-stages.jsonl', 'TensorFlowFixture', 'CalibrationMap', 'tensorflowFixtureSha256', 'calibrationFixtureSha256')
