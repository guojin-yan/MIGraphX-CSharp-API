...
$sourceChecks = @{
    ...
    'native\fake-migraphx\fake_m12.inc' = @('m12_live_count', 'migraphx_experimental_custom_op_register', 'fake_invoke_custom_callbacks', 'fake_invoke_custom_compute_with_error_buffer')
