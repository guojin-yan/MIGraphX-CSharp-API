...
$sourceChecks = @{
    ...
    'tools\m12-provider-callback-probe\Program.cs' = @('fake-native-provider-dispatch', '--provider-fixture', 'm12_runtime_provider_callback_probe', 'callback-invoked-controlled-rejection', 'callback-invoked-reference-matched', 'numerical-output', 'migraphx_shape_assign_to', 'migraphx_argument_buffer', 'expectedInformational')
