...
if (@($coreBaseline | Where-Object { $_.StartsWith('T|', [StringComparison]::Ordinal) }).Count -ne 45 -or
    @($coreBaseline | Where-Object { -not $_.StartsWith('#', [StringComparison]::Ordinal) -and -not $_.StartsWith('T|', [StringComparison]::Ordinal) -and $_.Length -ne 0 }).Count -ne 308 -or
    ...
    throw 'Current core public API baseline must remain 45/308 and adapter 3/11.'
}
