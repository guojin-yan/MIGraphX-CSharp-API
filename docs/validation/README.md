...
M1 through M11 evidence keeps execution evidence separate from distribution policy. Historical official records remain in `compatibility/runtime-validation-matrix.json`; M10 post-build promotion and M11 cases are separate machine-readable evidence:
