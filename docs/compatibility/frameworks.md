...
The M10 schema 2 update records 27 core public types and 160 non-type records, plus the unchanged adapter 3 types and 11 members, identically on all 15 TFMs. Representative M10 fake-native execution traverses `net46`, `netcoreapp3.1`, `net7.0`, and `net10.0`.
