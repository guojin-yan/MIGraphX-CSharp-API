...
The historical M10 schema 2 snapshot recorded 27 core public types and 160 non-type records. The current M12 local snapshot records 45 core public types and 303 non-type records, plus the unchanged adapter 3 types and 11 members, identically on all 15 TFMs. Representative M10 fake-native execution traverses `net46`, `netcoreapp3.1`, `net7.0`, and `net10.0`; the M12 graph fake-native path now traverses the same four representative TFMs.
