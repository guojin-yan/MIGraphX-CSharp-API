...
| --- | --- | --- |
| Managed build/API | M1 through M12 local validation | Core and adapter compile all 15 exact TFMs; the current schema 2 snapshots contain 45/303 and 3/11 records; M12 has two reviewed case-level runtime decisions and retains thirteen deferred cases |
