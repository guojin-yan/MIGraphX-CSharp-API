...
.\eng\build.ps1 -Configuration Release -Version 0.9.0-rc.9 -RepositoryCommit $commit
.\eng\verify-public-api.ps1 -Configuration Release -Version 0.9.0-rc.9 -RepositoryCommit $commit -SkipToolBuild
```
