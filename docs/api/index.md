...
M3 adds no public API. Its full-header declarations, handles, enums, callbacks, and ABI metadata remain internal until later vertical slices establish lifetime and behavior contracts.
