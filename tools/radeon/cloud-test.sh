...
printf '{"schemaVersion":"1.4.0","commit":"%s","managedGates":"completed","header":"verified","officialNativeM1":"runtime-executed","officialOnnxM2":"runtime-candidate-executed-review-required","gpuInference":"runtime-candidate-executed-review-required","m9InferenceOptions":"runtime-candidate-executed-review-required","m12Candidate":"candidate-record-verified","m12CaseFilter":"all-candidate","m12ExecutedCases":14,"m12FunctionalCases":13,"m12CrossTargetFrameworks":3,"m12DeferredCases":8}\n' "${COMMIT_SHA}" > "${results}/summary.json"
